...
TRUNCATE TABLE GALLERY_METADATA;
...
INSERT INTO IMAGES (TITLE, GALLERY_ID) VALUES ('TEST REVISIONABLE IMAGE', (SELECT ID FROM GALLERIES WHERE NAME = 'Test Gallery 1'));

INSERT INTO REVISIONS(HEAD_REVISION, USER_ID, DATE_UPLOADED, IMAGE_ID) VALUES ('Y', (SELECT ID FROM USERS WHERE USER_NAME = 'admin'), sysdate(), (SELECT ID FROM IMAGES WHERE TITLE = 'TEST REVISIONABLE IMAGE'));

INSERT INTO FILES(REVISION_ID, FILENAME, FILEDATA) VALUES((SELECT R.ID FROM IMAGES I, REVISIONS R WHERE I.ID = R.IMAGE_ID AND I.TITLE = 'TEST REVISIONABLE IMAGE'), 'revision.jpg', LOAD_FILE('/Users/iainb/Public/revision.jpg'));
