...
INSERT INTO IMAGES (TITLE, GALLERY_ID) VALUES ('TEST IMAGE', (SELECT ID FROM GALLERIES WHERE NAME = 'Test Gallery 1'));

INSERT INTO REVISIONS(HEAD_REVISION, USER_ID, DATE_UPLOADED, IMAGE_ID) VALUES ('Y', (SELECT ID FROM USERS WHERE USER_NAME = 'admin'), sysdate(), (SELECT ID FROM IMAGES WHERE TITLE = 'TEST IMAGE'));
...
INSERT INTO REVISIONS(HEAD_REVISION, USER_ID, DATE_UPLOADED, IMAGE_ID) VALUES ('Y', (SELECT ID FROM USERS WHERE USER_NAME = 'admin'), sysdate(), (SELECT ID FROM IMAGES WHERE TITLE = 'TEST IMAGE 2'));
